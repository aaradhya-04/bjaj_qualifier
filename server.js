...
// ======== CONFIG ========
const PORT = 3000;
const YOUR_EMAIL = "aaradhya1503.be23@chitkara.edu.in";

// 👉 PUT YOUR NEW GEMINI KEY HERE
const GEMINI_API_KEY = "AIzaSyDsmC2oJxl2-7-lWpZXTaIld2ETwg0yEK0";
// ========================
...
// -------- WORKING GEMINI CALL (tested pattern) ----------
async function askGemini(question) {
  ...
  return answer.trim().split(/\s+/)[0]; // ensures single word
}
